                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <label for="blog_name" class="form-label"> Blog Name <span class="text-danger">*</span></label>
                                    <select id="blog_name" class="form-control" name="blog_name">
                                        <option value="">Select Blog Name</option>
                                        <?php
                                        $role_fetch_data = $this->blog_detail_model->role_fetch();
                                        foreach ($role_fetch_data as $data) { ?>
                                            <option value="<?php echo $data['id']; ?>"<?php if ($data['id'] === $row->blog_name ) echo 'selected="selected"'?>><?php echo $data['blog_name']; ?></option>
                                        <?php } ?>
