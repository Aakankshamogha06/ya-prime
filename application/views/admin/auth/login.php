...
<body>
    ...
    <script src="<?=base_url()?>public/admin/https://code.jquery.com/jquery-3.4.1.min.js"></script>
    <script src="<?=base_url()?>public/admin/https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js"></script>
