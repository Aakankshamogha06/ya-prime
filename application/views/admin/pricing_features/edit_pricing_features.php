<div class="container-fluid">
    <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <?php foreach ($view_pricing_features as $row) :

                    ?>
                        <div class="card-header">
                            <h5>Edit pricing_features</h5>
                            ...
                            <form class="form-horizontal" method="post" action="<?= base_url('pricing_features/pricing_features_update_data'); ?>">
                        ...
                        <div class="widget-footer text-left">
                            ...
                            <button type="submit" name="submit" value="update pricing_features" class="btn btn-primary " style="margin: 10px;">Update</button>
