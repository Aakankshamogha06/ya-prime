                    ...
                    <form class="form-horizontal" method="post" action="<?= base_url('blog_detail/blog_detail_submit_data'); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea type="text" name="meta_description" parsley-trigger="change" class="form-control" id="meta_description" placeholder="SEO Description " required></textarea>
                            </div>
                            <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea style="background-color:aquamarine;" type="text" name="blog_desc" parsley-trigger="change" class="form-control" id="blog_desc" placeholder="Blog Description  " required></textarea>
                            </div>
                            <div class="form-group col-md-12">
